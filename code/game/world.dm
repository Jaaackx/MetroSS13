/var/server_name = "Metro 13 - Metro 2033 Inspired"
/var/game_id = null
/var/list/warfare_taglines = list( "Russian","Slavic")// list("It's Getting Cold Out There", "New Guns", "New Classes", "Cold", "Winter", "Frozen Solid", "Frozen Trench Pizza", "Warcrime Simulator", "Your Heart Has Stopped", )
...
/world/proc/update_status()
	...
	s += " ("
	s += "<a href=\"https://discord.gg/xthVK85W3M\">" //This should be a config but it's not.
	s += "Discord"
	s += "</a>"
	s += ")"
