...
/datum/species
	...
	var/default_language = LANGUAGE_RUSSIAN   // Default language is used when 'say' is used without modifiers.
	var/language = LANGUAGE_RUSSIAN            // Default racial language, if any.
